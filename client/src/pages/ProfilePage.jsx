        ...
        <label htmlFor="avatar" className="flex items-center gap-3 cursor-pointer">
         ...
         type="file" id="avatar" accept=".png, .jpeg, .jpg" hidden />
          ...
          <textarea onChange={(e)=>setBio(e.target.value)} value={bio}
           placeholder="Write profile bio" required rows={4} className="p-2 
            border border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"></textarea>
         <button type="submit" className="bg-gradient-to-r from bg-purple-400 to-violet-600
         text-white rounded-md cursor-pointer">Save</button>
        </form>    
