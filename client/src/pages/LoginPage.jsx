...
return(
    ...
    justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl ">
      ...
      <img src={assets.logo_big} className="w-[min(30vw,250px)]" alt="" />
       ...
       border-gray-500 p-5 flex flex-col gap-6 rounded-lg shadow-lg ">
        <h2 className="font-medium text-2xl flex justify-between items-center ">
          {currState}
          {isDataSubmitted && <img src={assets.arrow_icon} onClick={()=>setIsDataSubmitted(false)} className="w-5 cursor-pointer" alt="" /> }
         ...
         <button type="submit" className="py-3 bg-gradient-to-r from bg-purple-400 to-violet-600
